...
csscheck: csscheck.o storepaths.o corefuns.o linkedlistfuns.o
	$(CC) $(CFLAGS) $(LDFLAGS) -o $@ csscheck.o storepaths.o corefuns.o linkedlistfuns.o `./libs/xml2-config --libs`
...
linkedlistfuns.o: src/linkedlistfuns.c
	$(CC) $(CFLAGS) -o $@ -c src/linkedlistfuns.c
